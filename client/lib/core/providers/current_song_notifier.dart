...
class CurrentSongNotifier extends _$CurrentSongNotifier {
  ...
  void updateSong(SongModel song) async {
    ...
    final audioSource = AudioSource.uri(Uri.parse(song.song_url),tag: MediaItem(id: song.id, title: song.song_name,artist: song.artist,artUri: Uri.parse(song.thumbnail_url)));
