                  ...
                  Row(
                    children: [
                      Column(
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(color: Pallete.whiteColor, fontSize: 24, fontWeight: FontWeight.w700),
                          ),
                          const SizedBox(height: 15),
                          Text(
                            currentSong.artist,
                            style: TextStyle(color: Pallete.subtitleText, fontSize: 16, fontWeight: FontWeight.w500),
                          ),
                        ],
                      ),
                      ...
                      IconButton(
                        ...
                        icon: Icon(
                          userFavourites.where((fav) => fav.song_id == currentSong.id).toList().isNotEmpty
